start:               ; Inicio de la sección de código
    li a1, 0x4A      ; Carga el valor hexadecimal 0x4A (J) en el registro a1 (semilla)
    ...
    li a4, 0xA       ; Carga el valor 10 en el registro a4 para generar solo 10 números
...
checking:            ; Inicio de la sección que comprueba si se han obtenido los 10 números aleatorios
    ...
    blt a3, a4, lsfr ; Comprueba si el valor del registro a3 es menor que el valor 10 (0xA en hexadecimal), si es así, salta a la sección lsfr
